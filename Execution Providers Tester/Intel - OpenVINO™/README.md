...
- **Executable directly (SUCCESS with complexification):** 30 (19.4%)
- **Executable via FALLBACK:** 54 (34.8%)
...
- **Executable directly (SUCCESS with complexification):** 5 (4.7%)
- **Executable via FALLBACK:** 42 (39.3%)
